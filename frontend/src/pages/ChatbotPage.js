      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="shadow-2xl border-2 h-[600px] flex flex-col">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950 rounded-t-lg flex-shrink-0">
            ...
            <CardContent className="p-0 flex-grow flex flex-col">
              {/* Chat Messages */}
              <div className="flex-grow overflow-y-auto p-4 space-y-4 max-h-96">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Get farming advice anytime, anywhere with our AI assistant
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Chat in English, Hindi, or Punjabi for better understanding
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Trained on agricultural best practices and expert recommendations
                </p>
              </CardContent>
            </Card>
          </div>
